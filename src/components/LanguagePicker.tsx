...
export function LanguagePicker({ onSelect }: LanguagePickerProps) {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center
      ...
      {/* Globe */}
      <div className="text-8xl mb-6 animate-[bounce-in_0.5s_cubic-bezier(0.34,1.56,0.64,1)]">
        🌍
      </div>

      {/* Titles */}
      <h1 className="text-3xl font-black text-white text-center mb-1 drop-shadow">
        Choose your language
      </h1>
      <h2 className="text-xl font-black text-white/80 text-center mb-2">
        Välj ditt språk
      </h2>
